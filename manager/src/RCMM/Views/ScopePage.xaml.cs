...
public sealed partial class ScopePage : Page
{
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        HideBuiltInsBox.IsChecked = !_vm.ShowBuiltIns;
    ...
    private void HideBuiltInsBox_Changed(object sender, RoutedEventArgs e)
    {
        if (_vm is null) return;
        _vm.ShowBuiltIns = HideBuiltInsBox.IsChecked != true;
